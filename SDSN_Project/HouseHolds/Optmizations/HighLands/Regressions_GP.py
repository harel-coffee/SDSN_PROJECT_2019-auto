...
lm = lm.fit(X,y)
# r2 for the linear regression with the test data set is 0.86
# neg_mean_absolute_error for the linear regression with the test data set is -84031.58
# neg_mean_squared_error for the linear regression with the test data set is 112462.12742181253
#%%
...
Results = cross_validate(gp, X, y, cv=10,return_train_score=True,n_jobs=-1
                         , scoring = scoring       )
...
#path = 'Results_Regressions/Kcross_valiadation_GP_NPC' + '_' +  scoring + '.csv'
#Results.to_csv(path)

# r2 for the gaussian process with the test data set is 0.98
# neg_mean_absolute_error for the gaussian process with the test data set is -22290.18
# neg_mean_squared_error for the gaussian process with the test data set is 39106.8877585522
#%%
