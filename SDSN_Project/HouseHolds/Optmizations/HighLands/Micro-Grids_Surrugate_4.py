...
model.Lost_Load_Probability =  0.01
...
#%%
# Battery parameters
Battery_Invesment_Cost  = [222, 800]
...
Generator_Invesment_Cost = [2000,2000]
...
#%%
# Other parameters
#Lost_Load_Probability  =  0.01    # Allowed a percentage of unmet demand in the system
#%%
...
Data_Villages = pd.read_excel('Data_Base_High_Lands.xls',index_col=0,Header=None)
...
#Data_Villages = Data_Villages.loc[Data_Villages['Y_deg']>-17.999999]
...
for i in village:
 ...
 #75   
    for n in range(50,Nruns):
        ...
        Fuel_Cost_1 = round(Fuel_Cost_1,2)
